...
public interface FoodWithExtrasRepository extends JpaRepository<FoodWithExtras, Long>{
	...
	@Query(nativeQuery = true ,value ="SELECT  f.code as codef,f.libelle,f.prix,f.image,c.name as  namec,e.code as codeex,e.name as nameex,e.quantite,e.prix_unitaire  "
